...
module.exports = (function(){
  ...
  Metrics.prototype.flush = function(flushInterval) {
    ...
    var timers = this.metrics.timers;
    var timer_counters = this.metrics.timer_counters;
    var pctThreshold = this.metrics.pctThreshold;
    var histogram = this.metrics.histogram;
    ...
    this.metrics.counter_rates = counter_rates;
